...
public class OrientDBSinkConfig extends AbstractConfig {
	...
	public static final String CONNECTION_STRING = "orientdb.connection.string";
	private static final String CONNECTION_STRING_DOC = "orientdb connection string";
	...
	public static ConfigDef CONFIG_DEF = new ConfigDef()
			.define(CONNECTION_STRING, Type.STRING, Importance.HIGH, CONNECTION_STRING_DOC)
